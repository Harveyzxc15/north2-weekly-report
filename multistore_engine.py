...
# 教育價佔比不計的門市（北二區排除永和/板橋誠品/花蓮，同 warranty_report_all.py 的 edu_excl）
EDU_EXCLUDE = {'009', '025', '055'}
...
AAR_TO_APR = {'009': '050', '055': '050', '025': '063'}   # AAR 門市 → 主要結帳 APR（無資料時顯示用）：永和→西門、花蓮→西門、板橋誠品→板橋遠百
